...
export class TailFill extends ShapeBase {
  ...
  protected id: number = TailFill._id++;
  ...
  constructor() {
    ...
    const grad: SVGLinearGradientElement = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "linearGradient"
    );

    const stop0: SVGStopElement = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "stop"
    );
    ...
    grad.setAttribute("id", `grad-${this.id}`);
