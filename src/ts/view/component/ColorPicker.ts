...
export class ColorPicker {
  ...
  private applyColor(elm: HTMLElement, r: number, g: number, b: number): void {
    const r16 = Math.round(r * 255).toString(16).padStart(2, '0');
    const g16 = Math.round(g * 255).toString(16).padStart(2, '0');
    const b16 = Math.round(b * 255).toString(16).padStart(2, '0');
